...
export default function Title({ onShowTeams, onShowTeams2, onShowAnalysisMenu, showMenu, setShowMenu, teams, onSelectTeam1, selectedTeam1 }) {
    ...
    const renderMenu = () => (
        <div id="menu" className="titleArea">
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px' }}>
                <div className="btnTitle" onClick={onShowTeams}>💻</div>
                <div className="btnTitle" onClick={onShowTeams2}>📱</div>
    ...
    const renderPopup = () => (
        <div id="popup" className="selectTeamPopup">
            <div className="row center">
                <div className="title">チーム選択</div>
                <div className="btnPopupClose" onClick={() => setShowPopup(false)}>❌</div>
            </div>
    ...
    return (
        <>
            ...
            <div className="header">
                {renderSettingBtn()}
                <div className="title">ハンド入力支援</div>
            </div>
            <div className="main">
